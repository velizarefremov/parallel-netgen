...
DLL_HEADER void Ng_SetPointIndex(Ng_Mesh * mesh, const int ei, const int index);
...
DLL_HEADER void Ng_SetSurfaceElementIndex(Ng_Mesh * mesh, const int ei, const int index);
...
DLL_HEADER void Ng_SetVolumeElementIndex(Ng_Mesh * mesh, const int ei, const int index);
...
DLL_HEADER void GetMyPoint (Ng_Mesh mesh, int num, double * x);
...
DLL_HEADER void
GetMyVolumeElement (Ng_Mesh mesh, int num, int * pi);

DLL_HEADER void
GetMySurfaceElement (Ng_Mesh mesh, int num, int * pi);

DLL_HEADER int GetBoundaryID(Ng_Mesh mesh, int id);

DLL_HEADER int GetDomIn(Ng_Mesh mesh, int id);
DLL_HEADER int GetDomOut(Ng_Mesh mesh, int id);

DLL_HEADER void SetBoundaryID(Ng_Mesh mesh, int triid, int newid);

/// Get parent of surface element.
...
DLL_HEADER Ng_Result Ng_CSG_FindPoints(Ng_CSG_Geometry *geom2, Ng_Mesh * mesh);
